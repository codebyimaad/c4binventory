                    ...
                    <div class="modal-body">
                      ...
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <form id="adsuppliarForm">
                         <div class="row">
                           <div class="col-md-6 col-lg-6">
                            ...
                            <label for="sup_name">Driver's Name *:</label>
                            <input type="text" class="form-control" id="sup_name" placeholder="Driver's name" name="sup_name">
                          </div>
                           </div>
                          <div class="col-md-6 col-lg-6">
                          <div class="form-group">
                         ...
                         <div class="col-md-6 col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sup_contact" placeholder="Contact number" name="sup_contact">
                          </div>
                        </div>
                         <div class="col-md-6 col-lg-6">
                          <div class="form-group">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                            <label for="supaddress">Truck Number Plate:</label>
                            <textarea rows="3" class="form-control" placeholder="Truck Number Plate" id="supaddress" name="supaddress"></textarea>
                          </div>
                        </div>
                    </div>
